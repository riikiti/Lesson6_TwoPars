...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView card0 = (ImageView) findViewById(R.id.imageView1);
    ImageView card1 = (ImageView) findViewById(R.id.imageView2);
    ImageView card2 = (ImageView) findViewById(R.id.imageView3);
    ImageView card3 = (ImageView) findViewById(R.id.imageView4);
    ImageView card4 = (ImageView) findViewById(R.id.imageView5);
    ImageView card5 = (ImageView) findViewById(R.id.imageView6);
    ImageView card6 = (ImageView) findViewById(R.id.imageView7);
    ImageView card7 = (ImageView) findViewById(R.id.imageView8);
    ImageView card8 = (ImageView) findViewById(R.id.imageView9);
    ImageView card9 = (ImageView) findViewById(R.id.imageView10);
    ImageView card10 = (ImageView) findViewById(R.id.imageView11);
    ImageView card11 = (ImageView) findViewById(R.id.imageView12);
